...
* This do-file creates Figure B1, panel B

/*----------------------------------------------------------------------------*/
*STEPS:
	*0. Set directories.
	*1. Copmutes the number of observations, with and without wage estimates, for the inverse sample.
/*-----------------------------------------------------------------------------*/
...
*------------------------------------------------------------------------------*
* 1) Generate graphs with number of observations with + without estimates -- inverse sample
*------------------------------------------------------------------------------*
...
graph export "$figures/Figure B1B.`fmt_pic'", replace
